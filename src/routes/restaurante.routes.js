...
import { editarProducto, obtenerProducto, listarProductos, crearProducto, borrarProducto } from '../controllers/productoController.js';
...
router.route("/productos/:id").put([validacionProducto] ,editarProducto).get(obtenerProducto).delete(borrarProducto)
